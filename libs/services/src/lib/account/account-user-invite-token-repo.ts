...
export interface AccountUserInviteTokenRepo {
    ...
    findByUserIdAndAccountId(userId: string, accountId: string): Promise<AccountUserInviteToken | null>
    findByUserIdAndAccountIdAndValid(userId: string, accountId: string): Promise<AccountUserInviteToken | null>
    findByUserIdAndAccountIdAndValid(userId: string, accountId: string): Promise<AccountUserInviteToken | null>
    findValidTokenByAccountIdAndEmail(accountId: string, email: string): Promise<AccountUserInviteToken | null>
